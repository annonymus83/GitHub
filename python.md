...
Cerrammos todo. Vamos a nuestro Inicio y buscamos la palabra **cmd** (es nuestra linea de 
comandos) y lo pinchamos. Escribimos *Python* luego `enter` y nos aparecera la version de python 
